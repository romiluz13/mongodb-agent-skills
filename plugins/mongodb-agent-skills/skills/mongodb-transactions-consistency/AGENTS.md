...
> generating, or reviewing MongoDB transaction and consistency patterns.
> Humans may also find it useful, but guidance here is optimized for
> automation and consistency in AI-assisted workflows.
...
3. [Retry and Error Handling](#3-retry-and-error-handling) — **CRITICAL**
   - 3.1 [Handle Duplicate-Key Upsert Retry Behavior in Transactions (7.0.22+, 8.0.11+, 8.1+)](#31-handle-duplicate-key-upsert-retry-behavior-in-transactions-7022-8011-81)
...
Reference: [https://www.mongodb.com/docs/v8.0/core/transactions-in-applications.md](https://www.mongodb.com/docs/v8.0/core/transactions-in-applications.md)
Reference: [https://www.mongodb.com/docs/v7.0/core/transactions-in-applications.md](https://www.mongodb.com/docs/v7.0/core/transactions-in-applications.md)
...
### 3.1 Handle Duplicate-Key Upsert Retry Behavior in Transactions (7.0.22+, 8.0.11+, 8.1+)
