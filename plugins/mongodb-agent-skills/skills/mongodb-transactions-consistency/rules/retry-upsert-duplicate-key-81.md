...
Reference: [Transactions in Applications (current)](https://www.mongodb.com/docs/manual/core/transactions-in-applications.md)
Reference: [Transactions in Applications (MongoDB 8.0)](https://www.mongodb.com/docs/v8.0/core/transactions-in-applications.md)
Reference: [Transactions in Applications (MongoDB 7.0)](https://www.mongodb.com/docs/v7.0/core/transactions-in-applications.md)
