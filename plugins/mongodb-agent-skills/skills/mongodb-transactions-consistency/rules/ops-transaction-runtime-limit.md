...
The server manual does not define a fixed "documents modified per transaction" limit for normal application design. Keep batch sizing workload-driven: use short transactions, monitor aborts, and tune chunk size against your deployment's contention, lifetime limits, and cache pressure.
